...
public class DivisaoDoisVetores {
    public static void main(String[] args) {
        ...
        -Atribuir a divisão dos vetores A e B num terceiro Vetor (C) no tipo float
        ...
        */
        ...
        for(int i = 0; i < vetorB.length; i++){
            ...
            //Atribuindo a divisão dos vetores A e B num terceiro Vetor (C)
